...
public class BulletShellGenerator : ObjectPool
{
    ...
    [SerializeField]
    private float flyStrength = 1.5f;
    ...
    private void MoveShellInRandomDirection(GameObject shell)
    {
        ...
        shell.transform.DOMove(((Vector2)transform.position + randomDirection)
            * flyStrength, flyDuration).OnComplete(() => shell.GetComponent<AudioSource>().Play());
