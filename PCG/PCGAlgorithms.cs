...
public static class Direction2D
{
    public static List<Vector2Int> cardinalDirectionsList = new List<Vector2Int>
    {
        ...
        new Vector2Int(3, 3), // upright
        new Vector2Int(3, 0), // right
        new Vector2Int(3, -3), // rightdown
        new Vector2Int(0, -3), // down
        new Vector2Int(-3, -3), // leftdown
        new Vector2Int(-3, 0), // left
        new Vector2Int(-3, 3), // leftup

    };

    public static List<Vector2Int> cardinalDirectionsUnitList = new List<Vector2Int>
    {
    ...
    public static Vector2Int GetRandomCardinalUnitDirection()
    {
        return cardinalDirectionsUnitList[Random.Range(0, cardinalDirectionsList.Count)];
    }
}
